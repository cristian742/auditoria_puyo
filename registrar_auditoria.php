...
// Verificar si el usuario está autenticado y es auditor
if (!isset($_SESSION['user']) || $_SESSION['rol'] != 'auditor') {
    header("Location: index.php");
    exit();
}

$id_auditor = $_SESSION['id_usuario']; // ID del auditor desde la sesión
?>
    ...
    <div class="navbar-lateral full-reset">
        ...
        <div class="full-reset container-menu-movile custom-scroll-containers">
            ...
            <div class="full-reset nav-lateral-list-menu">
                ...
                <li><a href="registrar_auditoria.php"><i class="zmdi zmdi-book zmdi-hc-fw"></i>&nbsp;&nbsp; Reporte Auditoria</a></li>
